...
describe("CategoryController", () => {
    ...
    it("should get the main categories on GET /api/category", function (done) {
        this.timeout(100000);
    ...
    it("should get the sub categories for a main category on GET /api/category/:mainCategory", function (done) {
        this.timeout(100000);
