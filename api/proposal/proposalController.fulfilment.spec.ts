...
describe("ProposalController fulfilment", () => {
            ...
            function processDelivery(cb) {
                ...
                request(theApp)
                    ...
                    .expect(function (res) {
                        ...
                        assert.isTrue(backer[8], "Delivery of backer 1 has been reported");
                        assert.isTrue(backer[9], "Delivery of backer 1 is reported as correct");
                    })
                    .end(cb);
            },
        ], done);
    ...
    it("should execute end payment on proposal with delivery quotum reached on POST /api/proposal/:id/process-payments", function (done) {
        this.timeout(3300000);
            ...
            function processPayments(cb) {
                ...
                request(theApp)
                    ...
                    .expect(function (res) {
                        ...
                        var backer2 = proposalContract.backers(2);
            ...
            function processDelivery(cb) {
                ...
                request(theApp)
                    ...
                    .expect(function (res) {
                        ...
                        assert.isTrue(proposalContract.isDeliveryComplete(), "Delivery quorum is reached");
                    })
                    .end(cb);
            },
            function processPayments(cb) {
                // Call process-payments again to make the end payment and payout gets paid
                request(theApp)
                    .post('/api/proposal/' + proposal.contractAddress + "/process-payments")
                    .expect('Content-Type', /json/)
                    .expect(res => testHelper.checkStatusCode(res))
                    .expect(function (res) {
                        ...
                        assert.ok(backer[6], "End payment of backer 1 has been registered");
                        assert.equal(backer[7].toNumber(), 8, "End payment amount of backer 1 is correct");
                        ...
                        assert.equal(proposalContract.endPayoutAmount().toNumber(), 14, "End payout amount is correct");
                    })
                    .end(cb);
            },
        ], done);
