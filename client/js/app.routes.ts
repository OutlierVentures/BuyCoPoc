...
function AppRoutes($routeProvider: ng.route.IRouteProvider, $locationProvider: ng.ILocationProvider) {
    $routeProvider
        .when('/', { controller: Controllers.DashboardController, templateUrl: 'views/dashboard.html' })
        ...
        // TODO BW dd. 2015-01-06: To get proper 404 this otherwise route should be omitted and have the server have a special 'not-found' route to return the 'not-found' view. Because the client side can not set 404 status.
